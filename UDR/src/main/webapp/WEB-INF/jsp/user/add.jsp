...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>UDR - <spring:message code="add-user" text = "Add User"/></title>
        ...
        <div class="wrapper">
            ...
            <div id="myPane">
                ...
                <div class="ui-layout-center">
                    <div class="main-form">
                        <div class="main-form-header">Create user</div>
                        <form:form action="../user/add" commandName="userModel">
                            ...
                            <form:errors cssClass="ui-state-error-text" path="*" />
                        </form:form>
                    </div>
                </div>
                <!-- End of Right Side -->
