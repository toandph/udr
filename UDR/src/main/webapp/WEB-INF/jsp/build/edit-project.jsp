...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>UDR - <spring:message code="edit-project" text="Edit Project Info"/></title>
        ...
        <div class="wrapper">
            ...
            <div id="myPane">
                <div class="ui-layout-center">
                    <div class="main-form">
                        <div class="main-form-header"><spring:message code="edit-project" text="Edit Project"/></div>
                        <form:form commandName="projectModel" action="../build/edit-project?projectId=${projectId}">
                            <table width="500" border="0" cellpadding="0" cellspacing="4">
                                <tr>
                                    ...
                                    <td width="78%" align="left">
                                        <form:input path="name" class="myInput" style="width:100%" type="text" maxlength="30"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="78%" align="left">
                                        <form:input path="type" readonly="true" class="myInput" style="width:100%;background-color: #EEE" type="text" maxlength="30"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top"></td>
                                    <td width="78%" align="right" class="special-for-form-submit-button">
                                        <button onclick="location.href='../build/view-project'">
                                            <spring:message code="save" text="Save"/>
                                        </button>
                                        <button type="button" onclick="location.href='../build/detail?projectId=${projectId}'">
