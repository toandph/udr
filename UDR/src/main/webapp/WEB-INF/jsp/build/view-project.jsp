...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>UDR - <spring:message code="view-project-info" text="View Project Info"/></title>
                ...
                $("#delete-project-button").click(function() {
                    $( "#dialog-confirm" ).dialog({
                        ...
                        buttons: [ {text:$("#message-1").html(),
                            click:function() {
                                paramString = "projectId="+$("#projectId").html();
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="myPane">
                <div class="ui-layout-center">
                    <div class="main-form">
                        <div class="main-form-header"><spring:message code="view-project-info" text="View Project Info"/></div>
                            <table width="500" border="0" cellpadding="0" cellspacing="4">
                                <tr>
                                    ...
                                    <td width="78%" align="left">
                                        <input readonly="true" class="myInput" style="width:100%; background-color:#EEE;" type="text" maxlength="30" value="${detail.name}"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="78%" align="left">
                                        <input readonly="true" class="myInput" style="width:100%; background-color:#EEE;" type="text" maxlength="30" value="${detail.createdTime}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="22%" align="left">
                                    ...
                                    <td width="78%" align="left">
                                        <input readonly="true" class="myInput" style="width:100%; background-color:#EEE;" type="text" maxlength="30" value="${detail.lastBuild.type}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top"></td>
                                    <td width="78%" align="right" class="special-for-form-submit-button">
                                        <button onclick="location.href='../build/edit-project?projectId=${projectId}'">
                ...
                <div class="ui-layout-west">
                    <div id="accordion">
                        <h3 id="accordionMenu">
                            <strong><spring:message code="project-admin" text="Project Admin"/></strong>
                        </h3>
                        <div>
        ...
        <div id="dialog-confirm" title="Delete project?" style="display:none">
            <p>
                ...
                <spring:message code="this-project-will-be-delete-are-you-sure" text="This project will be deleted. Are you sure?"/>
            </p>
        </div>

        <span style="display:none" id="message-1"><spring:message code="delete-project" text = "Delete Project"/></span>
