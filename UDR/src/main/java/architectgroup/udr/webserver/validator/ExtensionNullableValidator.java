 ...
 * Time: 9:13 PM
 */
public class ExtensionNullableValidator implements ConstraintValidator<CheckExtensionNullable, CommonsMultipartFile> {
    private String extension;

    public void initialize(@NotNull CheckExtensionNullable constraintAnnotation) {
